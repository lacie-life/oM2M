...
public final class DBEntities {
	...
	/** Name used for the persisted {@link Cse} entity */
	public static final String CSE_ENTITY = "CSE";
	/** Name used for the persisted {@link CseBase} entity */
	public static final String CSE_BASE_ENTITY = "CSEBASE";
