...
@XmlRootElement
public class Cses extends Resource {

    @XmlSchemaType(name = "dateTime")
    protected String creationTime;
    @XmlSchemaType(name = "dateTime")
    protected String lastModifiedTime;
    protected NamedReferenceCollection cseCollection;
     ...
     *
     */
    public NamedReferenceCollection getCseCollection() {
        if (cseCollection == null){
            cseCollection = new NamedReferenceCollection();
        }

        return cseCollection;
    }
     ...
     *
     */
    public void setCseCollection(NamedReferenceCollection value) {
        this.cseCollection = value;
    }
    ...
    public String toString() {
        return "Cses [accessRightID=" + accessRightID + ", creationTime="
                + creationTime + ", lastModifiedTime=" + lastModifiedTime
                + ", cseCollection=" + cseCollection
