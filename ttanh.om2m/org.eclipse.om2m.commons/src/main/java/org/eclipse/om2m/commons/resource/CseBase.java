...
@Entity(name=DBEntities.CSE_BASE_ENTITY)
public class CseBase extends Resource {
    ...
    @Transient
    protected String csesReference;
    @XmlSchemaType(name = "anyURI")
    @Transient
     ...
     *
     */
    public String getCsesReference() {
    	if (csesReference == null && uri != null) { 
    		return uri + Refs.CSES_REF;
    	} else {
    		return csesReference;
    	}
    }
     ...
     *
     */
    public void setCsesReference(String value) {
        this.csesReference = value;
    }
    ...
    public String toString() {
        return "CseBase [accessRightID=" + accessRightID + ", searchStrings="
                + searchStrings + ", creationTime=" + creationTime
                + ", lastModifiedTime=" + lastModifiedTime + ", aPocHandling="
                + aPocHandling + ", csesReference=" + csesReference
