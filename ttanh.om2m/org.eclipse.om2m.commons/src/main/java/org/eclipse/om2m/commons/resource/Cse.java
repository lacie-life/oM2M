...
@Entity(name=DBEntities.CSE_ENTITY)
public class Cse extends Resource {
    ...
    public String toString() {
        return "Cse [pocs=" + pocs + ", remTriggerAddr=" + remTriggerAddr
                ...
                + attachedDevicesReference + ", cseId=" + cseId + ", uri="
                + uri + "]";
    }
}
