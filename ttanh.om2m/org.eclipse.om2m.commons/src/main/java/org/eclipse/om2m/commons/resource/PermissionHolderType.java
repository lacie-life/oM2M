 ...
 *         &lt;element ref="{http://uri.etsi.org/m2m}cseIDs" minOccurs="0"/>
...
public class PermissionHolderType {
     ...
     *
     */
    public void setCseIDs(CseIDs value) {
        this.cseIDs = value;
    }
	...
	public int hashCode() {
		...
		result = prime * result + ((cseIDs == null) ? 0 : cseIDs.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (cseIDs == null) {
			if (other.cseIDs != null) {
				return false;
			}
		} else if (!cseIDs.equals(other.cseIDs)) {
			return false;
		}
		return true;
	}
