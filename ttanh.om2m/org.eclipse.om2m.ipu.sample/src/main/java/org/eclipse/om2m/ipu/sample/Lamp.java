...
public class Lamp {
    ...
    public static String getDescriptorRep(String cseId, String appId, String stateCont) {
        ...
        opState.setHref(new Uri(cseId+"/"+"applications/"+appId+"/containers/"+stateCont+"/contentInstances/latest/content"));
        ...
        opStateDirect.setHref(new Uri(cseId+"/"+"applications/"+appId+"/"+APOCPATH));
        ...
        opON.setHref(new Uri(cseId+"/"+"applications/"+appId+"/"+APOCPATH+"/true"));
        ...
        opOFF.setHref(new Uri(cseId+"/"+"applications/"+appId+"/"+APOCPATH+"/false"));
        ...
        opToggle.setHref(new Uri(cseId+"/"+"applications/"+appId+"/"+APOCPATH+"/"+TOGGLE));
