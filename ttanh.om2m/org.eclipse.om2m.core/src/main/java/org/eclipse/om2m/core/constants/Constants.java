...
public class Constants {
    ...
    public static final String CSE_TYPE = System.getProperty("org.eclipse.om2m.cseType","IN");
    /** SclBase id. */
    public static final String CSE_ID = System.getProperty("org.eclipse.om2m.cseBaseId","in");
    ...
    /** listening context. */
    public static final String CSE_CONTEXT = System.getProperty("org.eclipse.om2m.cseBaseContext","/om2m");

    //The following properties are required only for mn to perform authentication on a remote in
    /** Connect to the remote SCL (if not NSCL) */
    public static final boolean IN_AUTHENTICATION = Boolean.valueOf(System.getProperty("org.eclipse.om2m.inAuthentication", "true"));
    /** Remote Nscl Id. (Required only for GSCL)*/
    public static final String IN_ID = System.getProperty("org.eclipse.om2m.remoteInId","in");
    /** Remote Nscl ip address. (Required only for GSCL)*/
    public static final String IN_IP = System.getProperty("org.eclipse.om2m.remoteInAddress","127.0.0.1");
    /** Remote Nscl listening port. (Required only for GSCL)*/
    public static final int IN_PORT = Integer.parseInt(System.getProperty("org.eclipse.om2m.remoteInPort","8080"));
    /** Remote Nscl listening port. (Required only for GSCL)*/
    public static final int IN_COAP_PORT = Integer.parseInt(System.getProperty("org.eclipse.om2m.remoteInCoapPort","5683"));
    /** Remote Nscl listening context. */
    public static final String IN_CONTEXT = System.getProperty("org.eclipse.om2m.remoteInContext","/om2m");
