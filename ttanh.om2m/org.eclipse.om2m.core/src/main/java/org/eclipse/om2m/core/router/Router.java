...
import org.eclipse.om2m.core.controller.CseController;
import org.eclipse.om2m.core.controller.CsesController;
...
public class Router implements CseService {
    ...
    public Controller getResourceController(String uri, String method, String representation){
        ...
        if(Patterns.match(Patterns.CSES_PATTERN,uri) && !method.equals(Constants.METHOD_CREATE)){
            return new CsesController();
        }
        if(Patterns.match(Patterns.CSE_PATTERN,uri) && !method.equals(Constants.METHOD_CREATE)|| (Patterns.match(Patterns.CSES_PATTERN,uri) && method.equals(Constants.METHOD_CREATE))){
            return new CseController();
        }
