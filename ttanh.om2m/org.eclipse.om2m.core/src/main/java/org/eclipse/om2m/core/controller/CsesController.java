...
public class CsesController extends Controller {
    ...
    public ResponseConfirm doRetrieve (RequestIndication requestIndication) {
        ...
        Cses cses = DAOFactory.getCsesDAO().find(requestIndication.getTargetID(), em);
		cses.setAccessRightID(accessRightID);
        em.close();
        
        // Set references
        cses.setMgmtObjsReference(cses.getUri() + Refs.MGMTOBJS_REF);
        cses.setSubscriptionsReference(cses.getUri() + Refs.SUBSCRIPTIONS_REF);
        // Response
        return new ResponseConfirm(StatusCode.STATUS_OK, cses);
