 ...
 *         </ul>
 */
public class CseBaseDAO extends DAO<CseBase> {
	 ...
	 */
	public CseBase find(String uri, EntityManager em) {
		// Retrieve the resource from the DB
		return em.find(CseBase.class, uri);
	}
	 ...
	 */
	public void delete(CseBase resource, EntityManager em) {		
		// Delete scls
		Cses cses = new Cses();
		cses.setUri(resource.getCsesReference());
		DAOFactory.getCsesDAO().delete(cses, em);
		// Delete applications
