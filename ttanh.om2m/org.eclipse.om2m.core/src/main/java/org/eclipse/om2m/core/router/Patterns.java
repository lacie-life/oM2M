...
public class Patterns {
	...
	/** Resource id pattern. */
    public static final String idPattern="(?!(cseBase|cses|cse|applications|application|applicationAnnc|containers|container|content|subscriptions|subscription|"
    ...
    public static final Pattern RETARGETING_PATTERN = Pattern.compile("(?!"+Constants.CSE_ID+")\\b\\w+\\b/*.*");

    /** Scls resource uri pattern. */
    public static final Pattern CSES_PATTERN = Pattern.compile(CSE_BASE_PATTERN+"/+cses/*");

    /** Scl resource uri pattern. */
    public static final Pattern CSE_PATTERN = Pattern.compile(CSES_PATTERN+"/+"+idPattern+"/*");

    /** Applications resource uri pattern. */
    public static final Pattern APPLICATIONS_PATTERN = Pattern.compile("("+CSE_BASE_PATTERN+"|"+CSE_PATTERN+")"+"/+applications/*");
    ...
    public static final Pattern CONTAINERS_PATTERN = Pattern.compile("("+CSE_BASE_PATTERN+"|"+CSE_PATTERN+"|"+APPLICATION_PATTERN+"|"+APPLICATION_ANNC_PATTERN+")"+"/+containers/*");
    ...
    public static final Pattern ACCESS_RIGHTS_PATTERN = Pattern.compile("("+CSE_BASE_PATTERN+"|"+CSE_PATTERN+"|"+APPLICATION_PATTERN+"|"+APPLICATION_ANNC_PATTERN+")"+"/+accessRights/*");
    ...
    public static final Pattern GROUPS_PATTERN = Pattern.compile("("+CSE_BASE_PATTERN+"|"+CSE_PATTERN+"|"+APPLICATION_PATTERN+"|"+APPLICATION_ANNC_PATTERN+")"+"/+groups/*");
    ...
    public static final Pattern DISCOVERY_PATTERN = Pattern.compile(CSE_BASE_PATTERN+"/+discovery/*.*");

    /** AttachedDevices resource uri pattern. */
    public static final Pattern ATTACHED_DEVICES_PATTERN = Pattern.compile(CSE_PATTERN+"/+attachedDevices/*");
    ...
    public static final Pattern MGMT_OBJS_PATTERN = Pattern.compile("("+CSES_PATTERN+"|"+CSE_PATTERN+"|"+APPLICATIONS_PATTERN+"|"+ATTACHED_DEVICE_PATTERN+")"+"/+mgmtObjs/*");
    ...
    public static final Pattern NOTIFICATION_CHANNELS_PATTERN = Pattern.compile("("+CSE_PATTERN+"|"+APPLICATION_PATTERN+")"+"/+notificationChannels/*");
    ...
    public static final Pattern M2M_POCS_PATTERN = Pattern.compile(CSE_PATTERN+"/+m2mPocs/*");
    ...
    public static final Pattern SUBSCRIPTIONS_PATTERN = Pattern.compile("("+CSE_BASE_PATTERN+"|"+CSE_PATTERN+"|"+CSES_PATTERN+"|"+APPLICATIONS_PATTERN+"|"+APPLICATION_PATTERN+
	...
	public static DAO getDAO(String uri){
        ...
        if(Patterns.match(Patterns.CSE_BASE_PATTERN,uri)){
            return DAOFactory.getCseBaseDAO();
        }
        
        if(Patterns.match(Patterns.CSE_PATTERN,uri)){
            return DAOFactory.getCseDAO();
        }
