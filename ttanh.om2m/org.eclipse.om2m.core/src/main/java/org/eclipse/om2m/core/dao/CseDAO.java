 ...
 *         </ul>
 */
public class CseDAO extends DAO<Cse> {
     ...
     */
    public Cse find(String uri, EntityManager em) {
    	// Return the resource from DB
        return em.find(Cse.class,uri);
    }
     ...
     */
    public void delete(Cse resource, EntityManager em) {
