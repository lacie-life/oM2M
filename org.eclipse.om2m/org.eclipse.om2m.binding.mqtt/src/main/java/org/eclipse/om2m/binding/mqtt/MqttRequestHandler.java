...
public class MqttRequestHandler implements MqttCallback {
	...
	public void messageArrived(String topic, MqttMessage message)
		...
		LOGGER.info("\n====MQTT REQUEST HANDLER====messageArrived=== NHAN BAN TIN TU AE =\n" 
				+ "\n topic = " + topic
				+ "\n messsage = " + message.toString()
				+ "\n mathcher = " + matcher.matches()
			);
		...
		if (matcher.matches()) {
			...
			//Sua ngay 24.01.2019 Test mqtt sub thi ban tin gui ve phai la json
	//		requestPrimitive.setReturnContentType(MimeMediaType.OBJ);
			...
			if(cseService != null){
				...
				LOGGER.info("\n====MQTT REQUEST HANDLER=====BAN TIN GUI VE===\n" 
						+ "\n responsePrimtive = " + responsePrimitive.toString()
				...
				LOGGER.info("\nResponse to be sent on topic: " + responseTopic + ". Payload:\n" + responsePayload);
