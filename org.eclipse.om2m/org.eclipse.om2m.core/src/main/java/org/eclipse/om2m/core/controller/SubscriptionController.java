...
public class SubscriptionController extends Controller{
	...
	private static Log LOGGER = LogFactory.getLog(SubscriptionController.class);
	...
	public ResponsePrimitive doCreate(RequestPrimitive request) {
		...
		try {
			if(request.getRequestContentType().equals(MimeMediaType.OBJ)){
				...
				Object debug=DataMapperSelector.getDataMapperList().
				...
				LOGGER.info("\n =======================Debugger Sub=========================== \n" 
						...
						+subscription.getNotificationURI()+ "\n getSubscriberURI== "
		...
		LOGGER.info("\n =======================Debugger Sub=========================== \n" 
				+"subscription.getAccessControlPolicyIDs()== "
				+ subscription.getAccessControlPolicyIDs() );
		...
		LOGGER.info("\n====================BAN TIN NAY GUI LAN DAU SUB ?=====================\n" 
		+ "Notifier.performVerificationRequest");
